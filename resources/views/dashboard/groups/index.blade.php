...
<div class="header-content">
	...
	<div class="actions-content">
		<a class="btn btn-add" href="{{ route('group.create') }}">
	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td class="acciones">
                    <a class="btn btn-view" href="{{ route('group.show', $item->id) }}"><i class="fas fa-eye"></i></a>
                    <a class="btn btn-edit" href="{{ route('group.edit', $item->id) }}"><i class="fas fa-edit"></i></a>
